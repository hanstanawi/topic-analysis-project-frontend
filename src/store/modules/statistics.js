...
const state = {
  dashboardLineChartStats: {
    ...
    series: [ // Y-Axis
      {
        name: '韓國瑜',
        data: [0, 2, 10, 7, 8, 12, 2, 1, 4, 0, 0, 0, 3, 4, 1, 4, 2, 5, 10, 4, 8, 6, 4, 2, 9],
      },
      {
        name: '肺炎',
        data: [0, 1, 3, 2, 4, 2, 2, 0, 1, 4, 2, 0, 0, 0, 3, 2, 5, 1, 4, 3, 5, 8, 2, 2, 1, 3],
      },
      {
        name: '國昌',
        data: [0, 2, 0, 0, 1, 4, 5, 1, 2, 3, 2, 3, 3, 5, 6, 8, 1, 4, 2, 4, 8, 6, 4, 2, 1, 2],
      },
      {
        name: '高雄',
        data: [2, 1, 4, 2, 4, 0, 2, 1, 5, 1, 2, 1, 2, 3, 0, 1, 3, 5, 3, 4, 8, 6, 4, 2, 9],
      },
      {
        name: '稅',
        data: [0, 1, 1, 2, 3, 1, 0, 5, 3, 2, 1, 4, 2, 7, 9, 1, 3, 5, 10, 4, 8, 6, 4, 2, 9, 1],
      },
    ],
  },
